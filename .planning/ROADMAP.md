...
- [ ] 02-01-PLAN.md — internal/git: Runner interface, ExecRunner (CRLF norm + exit-code mapping), ParseRefArgs ref grammar, ExitCodeError + table tests
...
| 2. Git Layer + CLI | 0/3 | Not started | - |
