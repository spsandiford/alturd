...
- [ ] 04-01-PLAN.md — internal/config package: TOML loader with strict validation (CONFIG-01), keymap-driven TUI dispatch (CONFIG-02), `--config` flag; leads with the phase tracer slice
...
- [ ] 04-03-PLAN.md — theme resolution with 50ms-bounded OSC 11 detection and `--theme` precedence (THEME-01), difftool single-file mode and title bar (DIFFTOOL-01, DIFFTOOL-02)
...
| 4. Config + Theming + Difftool + Distribution | 0/4 | Planned | - |
